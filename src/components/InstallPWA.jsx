            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-3">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-gradient-to-r from-[#0D1B4A] to-[#1a237e] text-white rounded-xl text-xs font-semibold hover:shadow-lg hover:shadow-blue-950/20 active:scale-95 transition-all"
                >
