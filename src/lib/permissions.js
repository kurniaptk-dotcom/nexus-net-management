...
export const ROLE_PRESETS = [
  {
    id: "admin",
    label: "Administrator (Kontrol Penuh)",
    badgeLabel: "Administrator",
    description: "Mengontrol penuh seluruh modul sistem, akun pengguna, penugasan tim, dan supervisi global",
  ...
  {
    id: "user",
    label: "Operator (Menjalankan Operasional Semuanya)",
    badgeLabel: "Operator",
    description: "Menjalankan operasional harian: penugasan teknisi, tiket gangguan, leads, ODP, & laporan",
  ...
  {
    id: "teknisi",
    label: "Teknisi (Hanya Menjalankan Tugas Khusus Timnya)",
    badgeLabel: "Teknisi",
    description: "Fokus khusus eksekusi tugas lapangan tim yang ditugaskan: rute maps, input redaman dBm, & SN ONT",
    colorClass: "bg-emerald-50 text-emerald-800 ring-1 ring-emerald-300",
    textColor: "text-emerald-700",
    borderColor: "border-emerald-300",
    defaultMenus: ["/teknisi"],
  },
  {
    id: "custom",
    label: "Role Kustom Tambahan",
    badgeLabel: "Kustom",
    description: "Daftar akses menu dikonfigurasi secara manual dan spesifik oleh Administrator",
    colorClass: "bg-slate-100 text-slate-800 ring-1 ring-slate-300",
    textColor: "text-slate-700",
    borderColor: "border-slate-300",
    defaultMenus: ["/teknisi", "/pekerjaan"],
  },
];
